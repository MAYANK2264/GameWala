      ...
      <div className="max-w-md mx-auto card p-6 space-y-4">
        ...
        {loading ? (
          ...
          <button
            ...
            type="button"
            className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-neutral-900 text-white px-4 py-2 hover:opacity-90"
          >
        ...
        <div className="text-xs text-neutral-500">If nothing happens on click, check that Google sign-in is enabled and localhost is in Authorized domains.</div>
      </div>
    </div>
  )
}
